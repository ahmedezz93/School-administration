            ...
            <div class="card card-statistics h-100">
                ...
                @endif
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('store_exams') }}" method="post" autocomplete="off">
                                @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="subject_id"> {{ trans('subjects.Subject Name') }} : <span class="text-danger">*</span></label>
