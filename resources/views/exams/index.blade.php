            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{ route('create_exams') }}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('edit_exams',$exam->id) }}" class="btn btn-info btn-sm" role="button" title="{{ trans('buttons.edit') }}" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                                      ...
                                                      <td>
                                                        <div class="modal fade" id="delete_exam{{ $exam->id }}" tabindex="-1"
                                                           ...
                                                           <div class="modal-dialog" role="document">
                                                               <form action="{{ route('delete_exams') }}" method="post">
                                                                  @csrf
