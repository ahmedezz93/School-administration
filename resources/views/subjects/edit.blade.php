            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('update_subjects') }}" method="post" autocomplete="off">
                                @csrf
                                <div class="form-row">
                                    <div class="col">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        <label for="inputState"> {{ trans('classrooms.class name') }}</label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('buttons.Save') }}
