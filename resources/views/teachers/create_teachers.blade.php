            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route('store_teachers') }}" method="post">
                             @csrf
                            <div class="form-row">
                                <div class="col">
                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Specialization_id">
                                        <option selected disabled>{{ trans('Teacher_trans.specialization') }}...</option>
                                        @foreach ($spectializations as $spectialization )
                                        <option value="{{ $spectialization->id }}">{{ $spectialization->name }}</option>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Gender_id">
                                        <option selected disabled>{{trans('Teacher_trans.Gender')}}...</option>
