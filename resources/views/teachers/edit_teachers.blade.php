                            ...
                            <div class="form-row">
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Specialization_id">
                                        <option value="{{$teachers->specializations->id}}">{{$teachers->specializations->name}}</option>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select my-1 mr-sm-2" name="Gender_id">
                                        <option value="{{$teachers->genders->id}}">{{$teachers->genders->name}}</option>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <div class='input-group date'>
                                        <input class="form-control" type="text"  id="datepicker-action"  value="{{$teachers->date}}" name="Joining_Date" data-date-format="yyyy-mm-dd"  required>
                                    </div>
                                    @error('Joining_Date')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
