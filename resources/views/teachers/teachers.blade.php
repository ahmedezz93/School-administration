...
@section('css')
    @toastr_css
@section('title')
    {{trans('main sidebar.List of teachers')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{ route('create_teachers') }}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit_teacher',$teacher->id) }}" class="btn btn-info btn-sm" role="button" aria-pressed="true" title="{{ trans('buttons.edit') }}"><i class="fa fa-edit"></i></a>
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_Teacher{{ $teacher->id }}" title="{{ trans('buttons.delete') }}"><i class="fa fa-trash"></i></button>
                                            </td>
