                    ...
                    <table id="datatable" class="table table-striped table-bordered p-0">
                        ...
                        <tbody>
                         ...
                         <td>{{  $account->student_accounts->sum('Debit')-$account->student_accounts->sum('Credit') }}</td>
                               ...
                               <td>
                                <a href="{{ route('details_accounts',$account->id) }}" class="btn btn-info">{{ trans('buttons.details') }}</a>
                                <a href="{{ route('delete_accounts') }}" class="btn btn-danger" data-toggle="modal" data-target="#delete_accounts">{{trans('buttons.delete') }}</a>
                                <a href="{{ route('filter_account',$account->id) }}" class="btn btn-warning">{{trans('fees.filtering student accounts') }}</a>
                            </td>
                               <td>
