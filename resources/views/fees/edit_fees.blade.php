        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{ route('update_fees') }}" method="post" autocomplete="off">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('fees.fees type in Arabic') }}</label>
                                <input type="text" value="{{$fee->getTranslation('name','ar')}}" name="title_ar" class="form-control">
                                <input type="hidden" value="{{$fee->id}}" name="id" class="form-control">
                            </div>

                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('fees.fees type in English') }}</label>
                                <input type="text" value="{{$fee->getTranslation('name','en')}}" name="title_en" class="form-control">
                            </div>


                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('fees.the cost') }}</label>
                                <input type="number" value="{{$fee->price}}" name="amount" class="form-control">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Grade_id">
                                    <option value="{{ $fee->grades->id }}" >{{ $fee->grades->name }}</option>
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Classroom_id">
                                    <option value="{{ $fee->classrooms->id }}">{{ $fee->classrooms->name }}</option>
                                </select>
                            </div>
                            <div class="form-group col">
