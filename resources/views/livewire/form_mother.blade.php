    ...
    <div style="display: none" class="row setup-content" id="step-2">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    <div class="col">
                        <label for="title">  اسم الام بالعربية</label>
                    ...
                    <div class="col">
                        <label for="title">اسم الام باللغة الانجليزية</label>
                ...
                <div class="form-row">
                    <div class="col-md-3">
                        <label for="title" >وظيفة الام بالعربية </label>
                    ...
                    <div class="col-md-3">
                        <label for="title">وظيفة الام بالانجليزية</label>
                    ...
                    <div class="col">
                        <label for="title">الرقم القومي للام</label>
                    ...
                    <div class="col">
                        <label for="title">رقم تليفون الام</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">جنسية الام</label>
                        <select class="custom-select my-1 mr-sm-2" wire:model="Nationality_Mother_id">
                            <option selected>حدد نوع الجنسية...</option>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">نوع الديانة</label>
                        <select class="custom-select my-1 mr-sm-2" wire:model="Religion_Mother_id">
                            <option selected>حدد نوع الديانة...</option>
...
@else
<button class="btn btn-danger btn-sm nextBtn btn-lg pull-right" type="button" wire:click="secondstepsubmit_edit">
    السابق
</button>
